...
if [ -z "$NO_BCDEVICE" ]; then
	...
	#install_link libGLESv1_CM_POWERVR_SGX530_121.so /system/lib/egl/libGLESv1_CM_POWERVR_SGX530_121.so


	install_file libusc.so /system/lib/libusc.so "shared library" 0644 0:0
	#install_link libusc.so /system/lib/libusc.so

	install_file libGLESv2_POWERVR_SGX530_121.so /system/lib/egl/libGLESv2_POWERVR_SGX530_121.so "shared library" 0644 0:0
	#install_link libGLESv2_POWERVR_SGX530_121.so /system/lib/egl/libGLESv2_POWERVR_SGX530_121.so

	install_file libglslcompiler.so /system/lib/libglslcompiler.so "shared library" 0644 0:0
	#install_link libglslcompiler.so /system/lib/libglslcompiler.so



	install_file libIMGegl.so /system/lib/libIMGegl.so "shared library" 0644 0:0
	#install_link libIMGegl.so /system/lib/libIMGegl.so
	install_file libEGL_POWERVR_SGX530_121.so /system/lib/egl/libEGL_POWERVR_SGX530_121.so "shared library" 0644 0:0
	#install_link libEGL_POWERVR_SGX530_121.so /system/lib/egl/libEGL_POWERVR_SGX530_121.so
	install_file libpvr2d.so /system/lib/libpvr2d.so "shared library" 0644 0:0
	#install_link libpvr2d.so /system/lib/libpvr2d.so



	install_file libsrv_um.so /system/lib/libsrv_um.so "shared library" 0644 0:0
	#install_link libsrv_um.so /system/lib/libsrv_um.so
	install_file libsrv_init.so /system/lib/libsrv_init.so "shared library" 0644 0:0
	#install_link libsrv_init.so /system/lib/libsrv_init.so
	install_file libPVRScopeServices.so /system/lib/libPVRScopeServices.so "shared library" 0644 0:0
	#install_link libPVRScopeServices.so /system/lib/libPVRScopeServices.so



	install_file gralloc.omap3.so /system/lib/hw/gralloc.omap3.so "shared library" 0644 0:0
	#install_link gralloc.omap3.so /system/lib/hw/gralloc.omap3.so

	install_file libpvrANDROID_WSEGL.so /system/lib/libpvrANDROID_WSEGL.so "shared library" 0644 0:0
	#install_link libpvrANDROID_WSEGL.so /system/lib/libpvrANDROID_WSEGL.so
#me add begin
install_file libeglinfo.so /system/lib/libeglinfo.so "shared library" 0644 0:0

install_file libgles1test1.so /system/lib/libgles1test1.so "shared library" 0644 0:0

install_file libgles1_texture_stream.so /system/lib/libgles1_texture_stream.so "shared library" 0644 0:0

install_file libgles2test1.so /system/lib/libgles2test1.so "shared library" 0644 0:0

install_file libgles2_texture_stream.so /system/lib/libgles2_texture_stream.so "shared library" 0644 0:0

install_file libtestwrap.so /system/lib/libtestwrap.so "shared library" 0644 0:0
#me add end
