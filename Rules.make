#Rules.make
ANDROID_ROOT_DIR=/home/wtbdaaaa/mydroid
TARGET_PRODUCT=nowplus
TARGET_ROOT=$(ANDROID_ROOT_DIR)
...
#KERNEL_INSTALL_DIR=$(ANDROID_ROOT_DIR)/kernel-2.6.37
KERNEL_INSTALL_DIR=$(ANDROID_ROOT_DIR)/../i8320kernel
#set filesystem path
TARGETFS_INSTALL_DIR=$(ANDROID_ROOT_DIR)/out/target/product/$(TARGET_PRODUCT)
#TARGETFS_INSTALL_DIR=/home/wtbdaaaa/r3d4
